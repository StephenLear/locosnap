...
- Stadler KISS (Class 445) vs Alstom LINT 27 disambiguation: These are completely different vehicles and must NOT be confused. **LINT 27** (Alstom Coradia LINT 27): a SHORT single-car or two-car diesel DMU, low-floor, used on rural branch lines, small rounded cab with a distinctive curved front, no pantograph, relatively narrow body, max ~120 km/h, operated by DB Regio and regional operators on secondary routes in Germany. **Class 445 KISS** (Stadler KISS): a TALL double-deck electric multiple unit (EMU), typically 4–6 cars, with pantographs on the roof, large double-deck windows visible along the entire bodyside, operated on high-capacity regional and intercity routes in Germany, Switzerland, and Austria — a completely different size class. The KISS towers over a LINT in height. There is also a **Class 445 Twindex** (Bombardier Twindexx / IC2): a double-deck push-pull train set hauled by a separate locomotive, with a distinctive flat-fronted control car. If a train has double-deck coaches and pantographs, it is the KISS or Twindex — NEVER a LINT 27. LINT 27 identifiers: single-deck, diesel (no pantograph), short vehicle, used on branch lines. KISS identifiers: double-deck, electric (pantograph visible), multi-car, used on main lines. Twindex identifiers: double-deck, loco-hauled, control car at one end.`;
