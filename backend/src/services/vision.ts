...
If you are looking at a white DB ICE high-speed train, you MUST first determine which ICE GENERATION it belongs to before identifying the specific class. There are FOUR distinct ICE generations and they must NOT be confused with one another.

STEP 1 — IDENTIFY THE ICE GENERATION:
- ICE 1 (BR 401): A locomotive-hauled train. Two SEPARATE POWER CARS, one at each end, which haul INTERMEDIATE COACHES — you can see the articulated connection/gangway between the power car and the first coach. The power car nose is long, rounded, and BULLET-SHAPED with an elongated dolphin-like profile tapering to a blunt rounded point. Built 1991–1996. 60 trainsets. 14-car formation. Max speed 250 km/h in service. Fleet numbers "401 xxx". This is NOT an EMU — the coaches are separate unpowered vehicles pulled by the loco-like power cars.
- ICE 2 (BR 402): Essentially a half-set of ICE 1. ONE power car (not two) with intermediate coaches and a flat-fronted Steuerwagen (driving trailer) at the other end. Same rounded bullet-shaped power car nose as ICE 1. Shorter formation (7 cars). Max speed 250 km/h. Fleet numbers "402 xxx".
- ICE 3 family (BR 403/406/407/408/462): A self-propelled distributed-power EMU — the entire train is one seamless unit with NO separate loco power cars. The nose tapers to a clear aerodynamic point (not a blunt rounded bullet like ICE 1/2). All cars are passenger-carrying. The cab windscreen is large and the overall nose profile is sharper and more modern than ICE 1/2.
- ICE 4 (BR 412): A self-propelled EMU. Wide, upright, flat-fronted cab with a SHARP HORIZONTAL CHIN EDGE below the windscreen and a prominent red band/bar. Does NOT taper to a point. Body noticeably wider than ICE 3. Built from 2017.

CRITICAL GENERATION RULE: If the ICE train has a ROUNDED, ELONGATED BULLET-LIKE NOSE with a blunt rounded tip (not a sharp aerodynamic point), it is ICE 1 (BR 401) or ICE 2 (BR 402) — it is NOT an ICE 3 variant and NOT a BR 412. The ICE 1/2 nose is distinctly older-looking and more rounded than all ICE 3/4 variants. If separate power cars are visible with a coach junction, it is definitely ICE 1 or ICE 2.

STEP 2 — IF ICE 3 FAMILY, DETERMINE THE EXACT CLASS:
- ICE 4 (BR 412): Wide, upright nose with SHARP HORIZONTAL CHIN EDGE and red band below windscreen. NOT pointed. Max speed 250 km/h. ~108 units.
- ICE 3 BR 407 (Velaro D): Smooth-tapering nose without sharp chin edge. Narrow profile with crease lines. Max speed 300 km/h. Only 17 units — extremely rare.
- ICE 3 BR 408 (ICE 3neo): Sharpest, most angular nose of any ICE 3 variant. Flattest cab face with very angular edges. Most modern appearance. Fleet numbers "408 xxx".
...
- ICE 3 family disambiguation (BR 403 / BR 406 / BR 407 / BR 408): All four classes share the same basic ICE white livery with red stripe and a broadly similar streamlined nose profile, making them easy to confuse. They MUST be distinguished carefully — do NOT use the generic label "ICE 3" or the generic designation "Class 403" when a more specific class can be determined. Use all available visual cues:
  ...
  **BR 408 (ICE 3neo, latest generation)**: Built 2022 onwards, most modern variant. SHARPEST, most angular nose of all ICE 3 variants — a very clean, modern, almost flat-faced cab with large rectangular windows and a prominent LED headlight cluster. Noticeably different from the softer 403/406 nose. Fleet numbers 408 001 onwards.
  ...
  CRITICAL RULES: (1) Never classify a BR 406 at Utrecht Centraal or Amsterdam as a BR 403 — the 403 does not operate there. (2) "ICE 3" is NEVER a valid value for the "class" field — it is a family name, not a class designation. You MUST always return a specific class: BR 403, BR 406, BR 407, BR 408, or (if it is the ICE 4) BR 412. Returning the generic string "ICE 3" is always wrong — if you find yourself about to write "ICE 3" as the class, STOP and force yourself to choose between BR 403, BR 406, BR 407, BR 408, and BR 412. (3) If the nose appears rounded/classic AND the location is the Netherlands or the Amsterdam–Frankfurt corridor, classify as BR 406. (4) If the nose appears angular with sharper creases, classify as BR 407. (5) If truly unable to distinguish between ICE 3 variants, return "BR 407" with lower confidence rather than the generic "ICE 3" label.
- ICE 4 (BR 412) vs ICE 3 family (BR 403/406/407/408) disambiguation: The ICE 4 and ICE 3 are COMPLETELY DIFFERENT trains — the ICE 4 is NOT a member of the ICE 3 family and must NEVER be classified as BR 403, 406, 407, or 408. **BR 412 (ICE 4)**: noticeably WIDER and LONGER body than ICE 3 (available in 8, 12, or 13-car formations — the 12 and 13-car variants are among the longest trains in Europe at over 300 metres). The ICE 4 nose is FLATTER and MORE UPRIGHT than all ICE 3 variants — it has a large rectangular windscreen, a pronounced chin/undercut below the windscreen, and a less pointed profile. The ICE 4 body has a more squared-off, boxy cross-section compared to the slimmer ICE 3. The ICE 4 cab front appears almost VERTICAL when viewed from the side — it does not taper to a sharp point like ICE 3 variants. The windscreen on BR 412 is notably WIDER and more rectangular, sitting higher up the cab front. Max speed 250 km/h (NOT 300 or 320 km/h). Fleet numbers start with "412" — definitive if visible. CRITICAL RULES: (1) If the ICE train formation is clearly very long (more than 8 cars), it is BR 412. (2) If the nose is flatter, wider, and more upright with a pronounced chin, it is BR 412 not BR 407. (3) BR 407 has a sharper, more angular pointed nose — if the nose is wide and upright rather than narrow and pointed, choose BR 412. (4) When in doubt between BR 407 and BR 412 on an 8-car formation: examine whether the nose tapers to a visible point (BR 407) or sits more upright and wide without a clear point (BR 412). If still uncertain, prefer BR 412 — since 2019 the BR 412 has been the most deployed ICE type in Germany by passenger numbers, making it statistically more likely at any major German terminus. (5) Never assign max speed of 300 or 320 km/h to a BR 412. (6) IMPORTANT: If you were about to return "ICE 3" as the generic class, that means you could not determine the exact ICE 3 variant — in that case, ALSO consider whether the wide, upright nose profile you observed might actually be BR 412 rather than any ICE 3 variant at all.
...
- EU07 / EU07A / EP07 / EP09 Polish electric locomotive family disambiguation: This is an extended family of Bo'Bo' electric locomotives built by Pafawag (Wroclaw). **EU07**: the original freight/mixed-traffic variant built 1963–1989, based on the British Class 83/84 design — classic boxy 1960s bodywork, rectangular cab windows, original electrical equipment, older-style grilles and ventilation panels. Operated by PKP Cargo (green/yellow livery), PKP Intercity, and PRIVATE FREIGHT OPERATORS including Rail Polska. **Rail Polska livery**: Rail Polska is a Polish private freight operator that paints their EU07-class locomotives in a distinctive bright RED body with YELLOW horizontal stripe and "RAIL POLSKA" text on the bodyside. If a boxy 1960s-profile Bo'Bo' electric loco with the EU07 body shape is photographed in red/yellow Rail Polska colours, classify it as EU07 (operator: Rail Polska). **EU07A**: a modernised sub-variant of the EU07, rebuilt from the 1990s onwards — same body but with updated cab equipment, modernised electronics, revised cab windows, and sometimes different horn/light arrangements. The most significant EU07A modernisation is the **type 303e**, rebuilt by HCP Poznan — this variant has substantially upgraded traction equipment giving it 3.2 MW continuous power (versus approximately 2.0 MW on the standard EU07) and a maximum speed of 160 km/h (versus 125 km/h on the standard EU07). The EU07A-001 is the first unit of this 303e modernisation. Visually, the 303e EU07A may show revised pantograph equipment distinct from the original EU07 pantographs. If fleet number "EU07A-001" or "EU07A-0XX" is visible, classify as EU07A and note the 303e modernisation type with the upgraded specs (3.2 MW, 160 km/h) rather than standard EU07 specs. **EP07**: the passenger-designated variant of the EU07 family, visually nearly identical to the EU07; operated by PKP Intercity on regional and express services. When visible fleet numbers begin "EP07", classify accordingly; otherwise EU07 is the default for ambiguous cases. **EP09**: a later and more powerful Bo'Bo' electric passenger locomotive, built 1986–1994 by Pafawag — the EP09 is distinguished by a prominent row of OVAL PORTHOLE WINDOWS along the upper bodyside, which is the single most recognisable feature of the class. The EP09 has a slightly more modern appearance than the EU07, typically in red PKP Intercity livery, used on express passenger services at up to 160 km/h. CRITICAL RULES: (1) If the Polish electric loco has clearly visible OVAL PORTHOLE WINDOWS in a row along the body, it is EP09 — not EU07 or EU07A. (2) If the locomotive is in red/yellow Rail Polska livery with the EU07 boxy profile and no oval portholes, classify as EU07 (operator: Rail Polska). (3) When the EU07 sub-variant cannot be determined from the image, classify as EU07 (parent class) and note it may be EU07A if modernisation features are visible. (4) Do NOT confuse any member of this family with the ET22 (see separate rule below). (5) If the fleet number is visible and begins "EU07A-", classify as EU07A — if it is specifically the 303e type (HCP Poznan modernisation, identifiable by revised pantograph equipment or fleet number EU07A-001 through EU07A-0XX), apply the upgraded specs of 3.2 MW and 160 km/h rather than the standard EU07 figures of ~2.0 MW and 125 km/h.
- ET22 (PKP Co-Co heavy freight electric) disambiguation: The ET22 is a large Co-Co electric freight locomotive built by Pafawag from 1969–1990, one of the most numerous Polish electric locomotives with over 1,100 units produced. CRITICAL DISTINGUISHING FEATURE: the ET22 has a CO-CO wheel arrangement — SIX axles across THREE bogies per side, making it visibly larger and longer than the Bo'Bo' EU07/EP07/EP09 family (which has only four axles across two bogies per side). The ET22 body is longer and heavier in proportion than the EU07. Technical specs: max speed 125 km/h, continuous power 3000 kW. Operated primarily by PKP Cargo in green/yellow livery and by various private Polish freight operators. CRITICAL RULES: (1) If the Polish electric freight locomotive appears large and long with six axles (Co-Co), it is almost certainly ET22, not EU07. (2) If the wheel arrangement is clearly four-axle (Bo'Bo') — two smaller bogies — it is the EU07 family, not ET22. (3) Do not confuse ET22 with the ET41 (a double-unit locomotive consisting of two permanently coupled EU07-type units working in multiple).
