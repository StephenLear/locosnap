...
export type SpecsOverride = Partial<Pick<TrainSpecs, "maxSpeed" | "power" | "weight" | "length" | "builder" | "fuelType" | "numberBuilt" | "gauge">>;
const WIKIDATA_CORRECTIONS: Record<string, SpecsOverride> = {
  ...
  "159": { maxSpeed: "120 km/h", power: "7,000 kW (electric) / 2,800 kW (diesel)", weight: "123 t", builder: "Stadler (Valencia)", fuelType: "Electro-Diesel (Bi-Mode: AC overhead + onboard diesel)", length: "23.0 m" },
  "br 159": { maxSpeed: "120 km/h", power: "7,000 kW (electric) / 2,800 kW (diesel)", weight: "123 t", builder: "Stadler (Valencia)", fuelType: "Electro-Diesel (Bi-Mode: AC overhead + onboard diesel)", length: "23.0 m" },
  "br159": { maxSpeed: "120 km/h", power: "7,000 kW (electric) / 2,800 kW (diesel)", weight: "123 t", builder: "Stadler (Valencia)", fuelType: "Electro-Diesel (Bi-Mode: AC overhead + onboard diesel)", length: "23.0 m" },
  "class 159": { maxSpeed: "120 km/h", power: "7,000 kW (electric) / 2,800 kW (diesel)", weight: "123 t", builder: "Stadler (Valencia)", fuelType: "Electro-Diesel (Bi-Mode: AC overhead + onboard diesel)", length: "23.0 m" },
  "baureihe 159": { maxSpeed: "120 km/h", power: "7,000 kW (electric) / 2,800 kW (diesel)", weight: "123 t", builder: "Stadler (Valencia)", fuelType: "Electro-Diesel (Bi-Mode: AC overhead + onboard diesel)", length: "23.0 m" },
  "eurodual": { maxSpeed: "120 km/h", power: "7,000 kW (electric) / 2,800 kW (diesel)", weight: "123 t", builder: "Stadler (Valencia)", fuelType: "Electro-Diesel (Bi-Mode: AC overhead + onboard diesel)", length: "23.0 m" },
  "stadler eurodual": { maxSpeed: "120 km/h", power: "7,000 kW (electric) / 2,800 kW (diesel)", weight: "123 t", builder: "Stadler (Valencia)", fuelType: "Electro-Diesel (Bi-Mode: AC overhead + onboard diesel)", length: "23.0 m" },
  ...
  // OBB 1216 "Taurus III" (Siemens ES64U4) — OBB multi-system EuroSprinter,
  // Bo'Bo', 230 km/h, 6,400 kW, multi-system (15kV + 25kV AC + 3kV DC) for
  // cross-border Austria–Germany–Italy (Brenner). ~50 units (1216 001–050),
  // from 2006. 1216 050 holds the world rail speed record for a conventional
  // loco (357 km/h, 2 Sep 2006). Rounded Taurus cab — NOT a Vectron / BR 193.
  // Added 2026-05-31 after an evangelist reported a 1216 returned as BR 193.
  "1216": { maxSpeed: "230 km/h", power: "6,400 kW", builder: "Siemens", numberBuilt: 50, fuelType: "Electric Multi-System (15 kV 16.7 Hz AC + 25 kV 50 Hz AC + 3 kV DC)" },
  "obb 1216": { maxSpeed: "230 km/h", power: "6,400 kW", builder: "Siemens", numberBuilt: 50, fuelType: "Electric Multi-System (15 kV 16.7 Hz AC + 25 kV 50 Hz AC + 3 kV DC)" },
  "öbb 1216": { maxSpeed: "230 km/h", power: "6,400 kW", builder: "Siemens", numberBuilt: 50, fuelType: "Electric Multi-System (15 kV 16.7 Hz AC + 25 kV 50 Hz AC + 3 kV DC)" },
  "baureihe 1216": { maxSpeed: "230 km/h", power: "6,400 kW", builder: "Siemens", numberBuilt: 50, fuelType: "Electric Multi-System (15 kV 16.7 Hz AC + 25 kV 50 Hz AC + 3 kV DC)" },
  "reihe 1216": { maxSpeed: "230 km/h", power: "6,400 kW", builder: "Siemens", numberBuilt: 50, fuelType: "Electric Multi-System (15 kV 16.7 Hz AC + 25 kV 50 Hz AC + 3 kV DC)" },
  "es64u4": { maxSpeed: "230 km/h", power: "6,400 kW", builder: "Siemens", numberBuilt: 50, fuelType: "Electric Multi-System (15 kV 16.7 Hz AC + 25 kV 50 Hz AC + 3 kV DC)" },
  "taurus iii": { maxSpeed: "230 km/h", power: "6,400 kW", builder: "Siemens", numberBuilt: 50, fuelType: "Electric Multi-System (15 kV 16.7 Hz AC + 25 kV 50 Hz AC + 3 kV DC)" },
  "taurus 3": { maxSpeed: "230 km/h", power: "6,400 kW", builder: "Siemens", numberBuilt: 50, fuelType: "Electric Multi-System (15 kV 16.7 Hz AC + 25 kV 50 Hz AC + 3 kV DC)" },
