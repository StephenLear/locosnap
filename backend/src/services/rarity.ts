...
- German regional fleet awareness: DB Class 643/644 (Talent) have been largely retired from DB mainline service and are now rare. DB Class 143 (ex-DR 243, LEW Hennigsdorf Bo'Bo' electric, 646 originally built) has been DRAMATICALLY REDUCED — DB Regio has withdrawn almost all of them by 2025–2026 and only a small number remain active with private freight operators or in heritage use. A BR 143 in DB Regio red/white push-pull passenger service in 2025–2026 is a RARE sighting, not "common" — the class is near-extinct in mainline passenger service despite its large original production run. Classify BR 143 as "rare" unless context clearly indicates a preserved/heritage example (then "epic"). Do not be fooled by the historical fleet size of 646 — the active fleet is a tiny fraction of that today.
