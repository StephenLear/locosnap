...
- **Polish EN57 family rarity (added 2026-04-28 after Polish tester "pafawag.w.obiektywie" reported a POLREGIO EN57 returning Legendary tier):** EN57 / EN57AL / EN57AKŁ / EN57AKS / EN57AK is by FAR the most numerous Polish multiple unit ever built — **1,438 units produced 1962–1993 by Pafawag (Wrocław)**, with hundreds still in active daily POLREGIO / Koleje Mazowieckie / Koleje Małopolskie / Łódzka Kolej Aglomeracyjna service in 2026. The EN57 is the **default, everyday Polish regional EMU** — comparable to the German BR 425 / 426 in ubiquity. Classify EN57 and ALL its modernised sub-variants (AL / AKŁ / AKS / AK / etc.) as **"common"** — never "rare", never "epic", and absolutely **NEVER "legendary"**. The "reason" field MUST reflect (a) ~1,438 units built — by far Poland's most numerous EMU class, (b) hundreds still in active service with multiple regional operators, (c) being gradually replaced by Newag Impuls and Pesa Elf 2 but the replacement is multi-decade and EN57 remains the dominant Polish regional EMU through the 2020s. Never describe EN57 as "rare", "extinct", "near-extinct", "limited", "specialized", "1 left", "few remaining", or any framing that suggests scarcity — Polish trainspotters will immediately spot the error and the app loses credibility for the Polish market. Modernised variants (EN57AL / AKŁ / AKS) are NEW livery + interior refurbs of the same Pafawag bodyshell — they are NOT a separate rare class. **EN71** is a closely related 4-car derivative of the EN57 (~67 units built); classify as "uncommon" reflecting the smaller fleet but same family DNA.
