...
| Latest Android Preview Build | v1.0.16 APK — https://expo.dev/accounts/stephenlear1/projects/locosnap/builds/ba143e37-ad40-4ed4-acc1-66529cec1f7d — sent to vattuoula 2026-04-06. Removes `<Redirect>` from _layout.tsx, replaces with useEffect to fix Android 16 infinite navigation loop crash. |
