...
| 2026-04-14 | v1.0.17 (preview build 5 — same build as 2026-04-07) | Onboarding new Polish tester Jan Kaczorkowski. Confirmed Pro slot via bilingual chase reply "yes" 2026-04-11. Sent install email with bilingual EN/PL body (Resend id 2c6ea6c2). Note: v1.0.17 is still the latest available Android APK — v1.0.18 and v1.0.19 iOS changes have NOT yet been built for Android. Android APK rebuild required to match iOS state. | https://expo.dev/accounts/stephenlear1/projects/locosnap/builds/be527909-08eb-4ef9-b95e-d6ba89180f6f | krawiec.jr69@gmail.com (Jan Kaczorkowski — Polish tester) |
