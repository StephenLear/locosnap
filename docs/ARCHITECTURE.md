...
> Last updated: 2026-04-23 (Google Play production access GRANTED; v1.0.20 AAB submitted to Play production at 100% rollout — versionCode 9 blocked by Play policy for READ_MEDIA_IMAGES/READ_MEDIA_VIDEO, frontend/app.json cleaned up and rebuilt as versionCode 10, re-submitted and currently in review along with German de-DE store listing, 176 countries + rest of world, and EN/DE release notes; BR 120 "Drehstromlok" DE ad stats captured — 518 combined views, 0 follower conversion on either platform, but strongest install conversion measured to date at ~1.5% view-to-install with 8 DE-dominant installs attributed on post day; DB BR 151 vs ČD Class 151 disambiguation fix shipped `fdc431d` during BR 151 ad prep — Krupp/Krauss-Maffei/Henschel builder, 170 units, 120 km/h, 6,000 kW, 118 t, 15 kV AC German mainlines override added to vision.ts + trainSpecs.ts prompts and WIKIDATA_CORRECTIONS map)
