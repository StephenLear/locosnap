...
> Last updated: 2026-04-20 (evening — BR 232 / Ludmilla factual override + Android v1.0.20 AAB built awaiting Play Store submission)
...
| Latest Android Production Build | **v1.0.20 AAB (versionCode 9) — built 2026-04-20 evening — https://expo.dev/artifacts/eas/7YbEaBTzzccMkr6A7gakSt.aab — awaiting Play Store submission** (build id `386f0d23-a8a7-49a5-a387-d1c579e10233`, autoIncrement bumped versionCode 8→9). Matches iOS v1.0.20 build 42 content: leaderboard username edit UI with EN + DE localisation + all backend vision/specs improvements active server-side (Dr18, Dv12, Sr1/2/3, BR 140, Urie S15, VR Sm2/Sm4/Sm5, Mireo vs Desiro HC, BR 232 Ludmilla). **Held from auto-submission pending user verification on 2026-04-21 AM** (final day of the 14-day Google Play tester window). Staged rollout recommended: 20% initial for first 48h. Previous: v1.0.17 AAB (versionCode 8) — built 2026-04-07 — https://expo.dev/artifacts/eas/9iNjvH7L9AFjeVq8KB1uhp.aab — submitted to Play Store closed testing track 2026-04-07. |
