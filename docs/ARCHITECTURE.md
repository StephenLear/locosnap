...
| iOS Version | 1.0.20 build 42 — **LIVE on App Store** (approved 2026-04-19 evening). Contains: leaderboard username edit UI with EN + DE localisation (auto-generated TrainFan names can be personalised in Profile, letters/numbers/underscores, 3–20 chars). Backend vision improvements (Dr18, Dv12, Sr1/Sr2/Sr3, BR 140 / E 40 factual overrides, BR 30506 LSWR Urie S15, VR Sm2/Sm4/Sm5 commuter EMU disambiguation, Siemens Mireo vs Desiro HC disambiguation) all deployed server-side and active for v1.0.20 users without an app update. Previous live release: v1.0.19 build 41 — Live on App Store 2026-04-14 (3 lifetime scans paywall, Pro upsell banner, BR 442/642 fix, card-reveal Rules of Hooks fix). v1.0.18 build 40 — Live on App Store 2026-04-12. v1.0.17 build 38 — Live on App Store 2026-04-09. IPA v1.0.17: https://expo.dev/artifacts/eas/kWHhX6gcrPpUBYT9Ky1AZg.ipa |
| Android Version | 1.0.20 versionCode 10 — **IN PLAY STORE REVIEW at 100% rollout** (submitted 2026-04-23 evening, submission id 792443c9-6fd9-422e-8911-d916e0a0c4c5). Permissions-cleaned rebuild of versionCode 9 (which was blocked by Play quick-check for READ_MEDIA_IMAGES/READ_MEDIA_VIDEO policy). Managed publishing OFF — auto-publishes on Google approval. Prior Android tester distribution: v1.0.19 APK (versionCode 8) — https://expo.dev/artifacts/eas/ispu2yQ9ZFMWc8x2Wq6Hwb.apk — sent to 22 testers 2026-04-14, confirmed running stable on Samsung S24 Android 16 (vattuoula 2026-04-15). |
