...
## Status
Build 17 submitted to TestFlight and App Store review. Dynamic aspect ratio fix confirmed working for vintage/schematic/cinematic. Technical style prompt updated to force portrait-fill layout. `supportsTablet: false` set to remove iPad screenshot requirement. App is in Apple review — typically 24-48 hours.
...
- **Current build**: v1.0.0, buildNumber 17, submitted to App Store review on 2026-02-18
- **TestFlight**: Build 17 available at appstoreconnect.apple.com/apps/6759280267/testflight/ios
